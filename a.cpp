 ...
 *   q     -- Quit program.
 * 
 * To compile the program, type something like:
 *
 *   cc -o airplane_gl airplane_gl.c \
...
void display (void) { 
  ...
  //draw_ground();
  glColor3f(1.0,1.0,0.70);   //change color of plane
  draw_airplane ();
...
int main (int argc, char *argv[]) {
 /* Re-set the world transformation. */
  //glLoadIdentity ();
  //glRotatef (-45, 0, 1, 0);
	printf("\t\t\t\t\tAIRPLANE SIMULATION\n\n\n\n\n\n\n\n\n\n\n");
	printf("\t\tRAKSHA R: 1JB14CS108\n");
	printf("\t\tREKHA G: 1JB14CS110\n\n\n");
